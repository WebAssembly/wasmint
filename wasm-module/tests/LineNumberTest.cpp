...
int main() {
    ...
    assert(module.function("$print")->mainInstruction()->line() == 4);
    assert(module.function("$print")->mainInstruction()->children().at(0)->line() == 5);

    assert(module.function("$main")->mainInstruction()->line() == 9);
    assert(module.function("$main")->mainInstruction()->children().at(0)->line() == 9);
